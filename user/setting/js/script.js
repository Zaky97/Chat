...
import { getStorage, ref as sref, uploadBytesResumable, getDownloadURL } from "https://www.gstatic.com/firebasejs/10.5.0/firebase-storage.js";
    ...
    const Setting = {
        ...
        accountSect(user) {
            ...
            editLinkGithub.onclick = () => popup.prompt({
                msg: 'GitHub Username<br>Ex: Zaky9277',
                max: 20,
                onyes: (res) => {
            ...
            editLinkTwitter.onclick = () => popup.prompt({
                msg: 'Twitter Username<br>Ex: Elon_Musk',
                max: 20,
                onyes: (res) => {
                    update(ref(db, 'users/' + currentID), {
                        twitter: res
